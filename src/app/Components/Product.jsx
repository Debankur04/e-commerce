...
const Product = () => {
  return (
    <div className='h-80 w-40 p-1 bg-slate-500 rounded-lg' >
        <Image
      ...
      className='my-2 h-1/2 rounded'
        ...
        <div className='bg-slate-500'>
            ...
            <button className='w-full flex gap-4 justify-center bg-green-500 hover:bg-green-700 ease-in duration-300 py-1 rounded-lg'>
